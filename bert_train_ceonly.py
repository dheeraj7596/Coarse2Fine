...
if __name__ == "__main__":
    ...
    df_train = pickle.load(open(pkl_dump_dir + "df_gen_ce_only_" + p + ".pkl", "rb"))
    ...
    for ch in parent_to_child[p]:
        child_df = pickle.load(open(pkl_dump_dir + "exclusive_ceonly_" + str(iteration) + "it/" + ch + ".pkl", "rb"))
    ...
    if dump_flag:
        for p in high_quality_inds:
            ...
            os.makedirs(pkl_dump_dir + "exclusive_ceonly_" + str(iteration + 1) + "it", exist_ok=True)
            pickle.dump(temp_df, open(
                pkl_dump_dir + "exclusive_ceonly_" + str(iteration + 1) + "it/" + index_to_label[p] + ".pkl", "wb"))
