...
python3 gpt_finetune_ce_kl_div.py 1 ${gpu} 1 ${plabel} fine ${dataset}
...
python3 gpt_finetune_ce_kl_div.py 1 ${gpu} 2 ${plabel} fine ${dataset}
echo "Generating Data.."
python3 generate_data.py 1 ${gpu} ${plabel} ${num} fine ${dataset}
echo "Training BERT.."
...
python3 gpt_finetune_ce_kl_div.py 1 ${gpu} 3 ${plabel} fine ${dataset}
echo "Generating Data.."
python3 generate_data.py 1 ${gpu} ${plabel} ${num} fine ${dataset}
echo "Training BERT.."
