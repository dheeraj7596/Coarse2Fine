import torch
from transformers import OpenAIGPTTokenizer, OpenAIGPTLMHeadModel, get_linear_schedule_with_warmup, AdamW
...
if __name__ == "__main__":
    ...
    tokenizer = OpenAIGPTTokenizer.from_pretrained('openai-gpt', bos_token='<|startoftext|>', pad_token='<|pad|>',
