...
python3 gpt2_fine_ceonly_ablation.py 1 ${gpu} 1 ${dataset} fine
...
python3 gpt2_fine_ceonly_ablation.py 1 ${gpu} 2 ${dataset} fine
...
python3 gpt2_fine_ceonly_ablation.py 1 ${gpu} 3 ${dataset} fine
